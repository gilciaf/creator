...
{
    public class ConfiguracaoEmailCiaf
    {
        public ConfiguracaoEmailCiaf(string email, string senha, string assunto, string mensagem, string servidorSmtp, int porta, bool ssl = true, bool mensagemHtml = true, int timeout = 100000, bool assincrono = true)
        {
            Email = email;
            Senha = senha;
            Assunto = assunto;
